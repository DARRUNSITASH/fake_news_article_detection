        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900 dark:text-white">FakeNews Detector</h1>
                <p className="text-sm text-gray-600 dark:text-gray-300">AI-Powered News Verification</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <ThemeToggle />
              <a
                href="/admin"
                className="px-4 py-2 text-sm font-medium text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 border border-blue-200 dark:border-blue-600 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/30 transition-colors"
              >
                Admin Panel
              </a>
            </div>
        ...
        <section className="py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-xl p-6 border border-white/50 dark:border-gray-700/50 transition-colors duration-300">
              ...
              <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-xl p-6 border border-white/50 dark:border-gray-700/50 transition-colors duration-300">
                ...
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Dual Verification</h3>
                <p className="text-sm text-gray-600 dark:text-gray-300">
